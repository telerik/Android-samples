 ...
 */
public class StackSplineAreaSeriesFragment extends Fragment implements ExampleFragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        FrameLayout rootView = (FrameLayout) inflater.inflate(R.layout.fragment_stack_spline_area_series, container, false);
    ...
    private RadCartesianChartView createChart() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            splineAreaSeries.setCombineMode(ChartSeriesCombineMode.STACK);
