 ...
 */
public class TooltipBehaviorFragment extends Fragment implements ExampleFragment{
    @Override
    ...
    private RadCartesianChartView createChart(){
        ...
        ChartTooltipBehavior ttBehavior = new ChartTooltipBehavior(this.getActivity());
        ttBehavior.setTriggerMode(TooltipTriggerMode.TAP);
        chart.getBehaviors().add(ttBehavior);
