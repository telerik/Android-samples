 ...
 */
public class SplineAreaSeriesFragment extends Fragment implements ExampleFragment {


    public SplineAreaSeriesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FrameLayout rootView = (FrameLayout)inflater.inflate(R.layout.fragment_spline_area_series, container, false);
    ...
    private RadCartesianChartView createChart(){
        ...
        splineAreaSeries.setValueBinding(new FieldNameDataPointBinding("value"));
        splineAreaSeries.setCategoryBinding(new FieldNameDataPointBinding("category"));
        ...
        splineAreaSeries.setVerticalAxis(verticalAxis);
        splineAreaSeries.setHorizontalAxis(horizontalAxis);

        //Bind series to data
        splineAreaSeries.setData(this.getData());

        //Add series to chart
        chart.getSeries().add(splineAreaSeries);
        return chart;
    }
